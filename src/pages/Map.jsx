    ...
    <div className="page" id="Map">
      ...
      >
        ...
        <group dispose={null} position={[0, 2, 0]} scale={isMobile ? 0.7 : 1}>
          {/* Harbor - Introduction */}
          {!collectedChaptersIds.includes(Chapters[0].id) ? (
            <BirdEyeViewSign
              animation={false}
              scale={s}
              position={[
          ...
          {/* Zepplin */}
          {!collectedChaptersIds.includes(Chapters[1].id) ? (
            <BirdEyeViewSign
              animation={false}
              scale={s}
              position={[
          ...
          {/* Balloon */}
          {!collectedChaptersIds.includes(Chapters[2].id) ? (
            <BirdEyeViewSign
              animation={false}
              scale={s}
              position={[
          ...
          {/* Windmill */}
          {!collectedChaptersIds.includes(Chapters[3].id) ? (
            <OverheadViewSign
              animation={false}
              scale={s}
              position={[
          ...
          {/* Banjo */}
          {!collectedChaptersIds.includes(Chapters[4].id) ? (
            <GroundViewSign
              animation={false}
              scale={s}
              position={[
          ...
          {/* Umbrella */}
          {!collectedChaptersIds.includes(Chapters[5].id) ? (
            <OverheadViewSign
              animation={false}
              scale={s}
              position={[
          ...
          {/* Antenna / Tower */}
          {!collectedChaptersIds.includes(Chapters[6].id) ? (
            <OverheadViewSign
              animation={false}
              scale={s}
              position={[
          ...
          {/* Radar / Transmitter */}
          {!collectedChaptersIds.includes(Chapters[7].id) ? (
            <GroundViewSign
              animation={false}
              scale={s}
              position={[
          ...
          {/* Swidish Horse */}
          {!collectedChaptersIds.includes(Chapters[8].id) ? (
            <GroundViewSign
              animation={false}
              scale={s}
              position={[
          ...
          {/* Arch */}
          {!collectedChaptersIds.includes(Chapters[9].id) ? (
            <OverheadViewSign
              animation={false}
              scale={s}
              position={[
          ...
          {/* Theatre */}
          {!collectedChaptersIds.includes(Chapters[10].id) ? (
            <OverheadViewSign
              animation={false}
              scale={s}
              position={[
          ...
          {/* Big Tree */}
          {!collectedChaptersIds.includes(Chapters[11].id) ? (
            <OverheadViewSign
              animation={false}
              scale={s}
              position={[
          ...
          {/* Megaphone */}
          {!collectedChaptersIds.includes(Chapters[12].id) ? (
            <GroundViewSign
              animation={false}
              scale={s}
              position={[
          ...
          {/* Fishnet */}
          {!collectedChaptersIds.includes(Chapters[13].id) ? (
            <BirdEyeViewSign
              animation={false}
              scale={s}
              position={[
          ...
          {/* UFO */}
          {!collectedChaptersIds.includes(Chapters[14].id) ? (
            <BirdEyeViewSign
              animation={false}
              scale={s}
              position={[
          ...
          {/* Lighttower */}
          {!collectedChaptersIds.includes(Chapters[15].id) ? (
            <OverheadViewSign
              animation={false}
              scale={s}
              position={[
          ...
          {/* Windsoack */}
          {!collectedChaptersIds.includes(Chapters[16].id) ? (
            <GroundViewSign
              animation={false}
              scale={s}
              position={[
