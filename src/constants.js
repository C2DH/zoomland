export const ViewTypeGround = 'ground'
export const ViewTypeOverhead = 'overhead'
export const ViewTypeBirdEye = 'birdEye'
...
export const ColorIntroduction = '#7c7c7c'
export const ColorHistory = '#306fc5'
export const ColorMedia = '#fa953b'
export const ColorHermeneutics = '#9e43c8'
export const ColorDigitalLandscapes = '#ed407d'
